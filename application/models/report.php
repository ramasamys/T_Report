...
$sql = "select calldate,clid,src,dst,disposition,sec_to_time(billsec) as b from cdr where uniqueid!='' and lastdata like '%DAHDI/%' order by calldate desc";
